...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1e4ade8c8ed09924432b4dada86ea4cc) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Andy Ray"];
          homepage = Some "https://github.com/ujamjar/reedsolomon";
          synopsis = "Reed-Solomon error correction CODEC";
          description = Some [OASISText.Para "Correct up to t symbol errors"];
          categories = [];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_nativeopt = [(OASISExpr.EBool true, ["-unsafe"])]
                   },
                   {
                      lib_modules =
                        ["Ops"; "Matrix"; "Poly"; "Galois"; "Codec"; "Iter"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "reedsolomon";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "rswebdemo.ml"});
               Executable
                 ({
                     cs_name = "test_iter";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "test_iter.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/ujamjar/reedsolomon.git";
                      src_repo_browser =
                        Some "https://github.com/ujamjar/reedsolomon";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "9ku2\2218p\202\029\205m`\230\019<K";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
