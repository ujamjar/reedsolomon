...
(* OASIS_START *)
(* DO NOT EDIT (digest: 94d438b3ba85a2e018941b2ed7006d4b) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ops"; "Matrix"; "Poly"; "Galois"; "Rs"];
                      lib_pack = true;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\235\195\157h\219\216\153\024\014\245\141Fz_\159L";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
